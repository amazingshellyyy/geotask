...
const render = data => {
  for (let i = 0; i < data.length; i++) {
    ...
    $("#list-group").append(`<form><li class="list-group-item" id="list${i +
      1}" listId="${list._id}">${list.listTitle}<a id="listlink" href="/detail?id=${list._id}" class="float-right btn btn-link">></a><ul class="items list-unstyled" style="display: none;">
      </ul></li></form>`);
